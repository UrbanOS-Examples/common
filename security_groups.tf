...
resource "aws_security_group" "private_workers" {
  ...
  vpc_id      = module.vpc.vpc_id
  tags = {
    "Name"                                                 = "${terraform.workspace}-private-eks_worker_sg"
    "kubernetes.io/cluster/${terraform.workspace}-private" = "owned"
  }
}
...
resource "aws_security_group" "public_workers" {
  ...
  vpc_id      = module.vpc.vpc_id
  tags = {
    "Name"                                                = "${terraform.workspace}-public-eks_worker_sg"
    "kubernetes.io/cluster/${terraform.workspace}-public" = "owned"
  }
}
