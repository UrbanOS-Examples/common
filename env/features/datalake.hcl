...
module "cloudbreak" {
  ...
  cloudbreak_dns_zone_id    = "${aws_route53_zone.internal_root_public_hosted_zone.zone_id}"
  cloudbreak_dns_zone_name  = "${aws_route53_zone.internal_root_public_hosted_zone.name}"
...
module "datalake" {
  ...
  ssh_key                        = "${aws_key_pair.cloud_key.key_name}"
  alb_certificate                = "${module.tls_certificate.arn}"
  datalake_dns_zone_id           = "${aws_route53_zone.internal_root_public_hosted_zone.zone_id}"
  ...
  skip_final_db_snapshot         = "${var.skip_final_db_snapshot}"
  parent_hosted_zone_name        = "${aws_route53_zone.internal_root_public_hosted_zone.name}"
  parent_hosted_zone_id          = "${aws_route53_zone.internal_root_public_hosted_zone.id}"
  recovery_window_in_days        = "${var.recovery_window_in_days}"
